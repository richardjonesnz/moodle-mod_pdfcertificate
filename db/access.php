...
/**
 * Capability definitions for the pdfcertificate module
 *
...
$capabilities = array(
    'mod/pdfcertificate:addinstance' => array(
    ...
    'mod/pdfcertificate:manage' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'manager' => CAP_ALLOW,
    ...
    'mod/pdfcertificate:delete' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'manager' => CAP_ALLOW,
    ...
    'mod/pdfcertificate:design' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'manager' => CAP_ALLOW,
