...
/**
 * This file keeps track of upgrades to the pdfcertificate module
 *
...
/**
 * Execute pdfcertificate upgrade from the given old version
 *
 * @param int $oldversion
 * @return bool
 */
function xmldb_pdfcertificate_upgrade($oldversion) {
